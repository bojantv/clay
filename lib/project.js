...
function createProjectContext(opts) {
  ...
  var _srvFollowUp = typeof opts.onGetServerFollowUpBehavior === "function" ? opts.onGetServerFollowUpBehavior() : null;
  sm.followUpBehavior = (_srvFollowUp && _srvFollowUp.behavior === "steer") ? "steer" : "queue";
