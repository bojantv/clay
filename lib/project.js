...
function createProjectContext(opts) {
  ...
  function dispatchScheduledMessage(session, schedText, schedDisplayText, opts2) {
    ...
    sdk.startQuery(session, schedText, null, ensureProjectAccessForSession(session));
  ...
  function sendScheduledMessageNow(session, opts2) {
    ...
    dispatchScheduledMessage(session, schedText, schedDisplayText, opts2);
    return true;
  }
