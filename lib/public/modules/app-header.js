...
export function initHeader() {
  ...
  if (headerInfoBtn) {
    headerInfoBtn.addEventListener("click", function (e) {
      ...
      var s = store.snap();
      addRow("Provider", providerLabel(s.currentVendor || "claude", s.currentProviderRouteId || null));
      if (s.currentModel) addRow("Model", modelDisplayName(s.currentModel, s.currentModels || []));
