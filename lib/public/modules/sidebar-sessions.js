    ...
    handoffItem.addEventListener("click", (function(routeForClick) {
      return function(e) {
        ...
        if (getWs() && store.get('connected')) {
          ...
          getWs().send(JSON.stringify({ type: "handoff_session", sessionId: sessionId, targetVendor: routeForClick.vendor, targetRouteId: routeForClick.id || null, targetModel: targetModel }));
        }
      };
    })(route));
