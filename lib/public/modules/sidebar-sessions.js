...
function renderSessionItem(s) {
  ...
  if (sessionVendor !== "codex") sessionVendor = "claude";
  var vendorDotClass = "session-vendor-dot " + sessionVendor + (s.isProcessing ? " processing" : "");
  textHtml += '<span class="' + vendorDotClass + '" title="' + sessionVendor + ' session"></span>';
