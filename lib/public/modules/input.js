...
export function sendMessage(options) {
  var explicitSteer = !!(options && options.steer);
  var steer = explicitSteer || !!(ctx.processing && ctx.followUpBehavior === "steer");
  var willQueue = !!(ctx.processing && !steer && ctx.followUpBehavior !== "steer");
