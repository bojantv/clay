...
import { handleQueuedUserMessage, setQueuedUserMessages, removeQueuedUserMessage, clearQueuedUserMessages } from './queued-messages.js';
...
function isStaleSessionMessage(msg) {
  ...
  return Number(msg.sessionId) !== Number(activeSessionId);
}
