...
function renderVendorSwitchDivider(msg) {
  ...
  var toLabel = msg.targetRouteLabel || providerLabel(msg.toVendor || "codex", msg.targetRouteId || null);
    ...
    switch (msg.type) {
      ...
      case "model_info": {
        ...
        if (Object.prototype.hasOwnProperty.call(msg, "model")) {
          ...
          var _hasSessionRoute = !!store.get('currentProviderRouteId');
          if ((store.get('vendorSelectionLocked') || _hasSessionRoute || _modelVal === "auto") && _existingModel) {
      ...
      case "vendor_switched":
        ...
        if (msg.toVendor) {
          ...
          store.set({
            ...
            currentModel: msg.targetModel || store.get('currentModel') || "",
          ...
          if (_avi3 && _avIcon3) {
            if (msg.toVendor === "claude") {
              _avIcon3.src = "/claude-code-avatar.png";
              _avIcon3.alt = "Claude";
              _avi3.title = "Claude session";
              _avi3.classList.remove("hidden");
            } else if (msg.toVendor === "codex") {
              _avIcon3.src = "/codex-avatar.png";
              _avIcon3.alt = "Codex";
              _avi3.title = "Codex session";
              _avi3.classList.remove("hidden");
            } else {
              _avi3.classList.add("hidden");
            }
          }
        }
        break;
      ...
      case "session_switched":
        ...
        if (msg.vendor) {
          ...
          store.set({ currentVendor: msg.vendor, currentProviderRouteId: msg.providerRouteId || null, currentModel: "", currentModels: [] });
          if (getWs() && getWs().readyState === 1) {
            getWs().send(JSON.stringify({ type: "get_vendor_models", vendor: msg.vendor }));
          }
          if (msg.hasHistory) {
          ...
          store.set({ currentVendor: "claude", currentProviderRouteId: null, currentModel: "", currentModels: [] });
