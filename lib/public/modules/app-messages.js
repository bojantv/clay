...
export function processMessage(msg) {
    ...
    switch (msg.type) {
      ...
      case "model_info": {
        ...
        if (_modelVal && msg.providerRouteId && !modelMatchesRouteFamily(_modelVal, msg.providerRouteId)) {
        ...
        if (msg.providerRouteId) _miUpdate.currentProviderRouteId = msg.providerRouteId;
        store.set(_miUpdate);
      ...
      case "vendor_switched":
        ...
        if (msg.toVendor) {
          ...
          var _routeName3 = providerShortName(msg.toVendor, msg.targetRouteId || null);
          if (_vtw3) {
            _vtw3.classList.add("hidden");
            _vtw3.classList.remove("locked");
          }
          if (_avi3 && _avIcon3) {
            _avIcon3.src = providerAvatar(msg.toVendor, msg.targetRouteId || null);
      ...
      case "session_switched":
        ...
        if (_avi && _avIcon) {
          if (msg.vendor) {
            var _routeName = providerShortName(msg.vendor, msg.providerRouteId || null);
            _avIcon.src = providerAvatar(msg.vendor, msg.providerRouteId || null);
