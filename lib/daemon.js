...
var relay = createServer({
  ...
  onGetServerFollowUpBehavior: function () {
    var behavior = config.defaultFollowUpBehavior === "steer" ? "steer" : "queue";
    return { behavior: behavior };
  },
  onSetServerFollowUpBehavior: function (behavior) {
    var normalized = behavior === "steer" ? "steer" : "queue";
    config.defaultFollowUpBehavior = normalized;
    saveConfig(config);
    return { ok: true, behavior: normalized };
  },
