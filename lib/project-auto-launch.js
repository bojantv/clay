...
function attachAutoLaunch(ctx) {
  ...
  function statePayload() {
    return Object.assign({ type: "auto_launch_state", recipes: listRecipes() }, getState());
  }
  ...
  function launchScheduled(recipeId, extraArgs) {
    ...
    for (var i = 0; i < items.length; i++) {
      ...
      started.push(tl.startSessionForItem(null, recipe, items[i], itemArgs, null, { auto: true }));
    }
