...
function createServer(opts) {
  ...
  var onGetServerFollowUpBehavior = opts.onGetServerFollowUpBehavior || null;
  var onSetServerFollowUpBehavior = opts.onSetServerFollowUpBehavior || null;
  ...
  function addProject(cwd, slug, title, icon, projectOwnerId, worktreeMeta, extraOpts) {
    ...
    var ctx = createProjectContext({
      ...
      onGetServerFollowUpBehavior: onGetServerFollowUpBehavior,
      onSetServerFollowUpBehavior: onSetServerFollowUpBehavior,
