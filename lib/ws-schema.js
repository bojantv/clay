...
var schema = {
  ...
  "list_cli_sessions":       { direction: "c2s", handler: "lib/project-sessions.js", description: "List CLI sessions in ~/.claude/projects/<cwd>/ that Clay isn't tracking (importable)" },
  ...
  "cli_session_list":         { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Response to list_cli_sessions: importable CLI sessions" },
  ...
  "set_server_follow_up_behavior": { direction: "c2s", handler: "lib/project-sessions.js", description: "Set server-wide follow-up behavior while a response is active" },
  "follow_up_behavior_changed": { direction: "s2c", handler: "lib/public/modules/app-messages.js", description: "Broadcast: follow-up behavior changed" },
